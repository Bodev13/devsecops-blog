...
export default function Hero() {
    const boImage = useBaseUrl("/img/portfolio/icons/bo.png");
                ...
                <div className={styles.hero__container}>
                    <div className={styles.hero__content}>
                        ...
                        <p className={styles.hero__text}>
                            I am a DevOps and Linux-focused engineer passionate about building reliable,
                            automated, and scalable systems. I enjoy working with Linux environments,
                            infrastructure, containers, and CI/CD pipelines.
                        </p>
